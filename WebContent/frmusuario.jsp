	...
	<form action="usucontroler.do" method="post">
		<div id="logo">
			...
			<div class="margin">
				...
				<label>Nome :</label>
				<input type="text" name="txtname" size="20" value="${requestScop.usuario.nome }"/> 
			</div>
			<div class="margin">
				<label>Login :</label>
				<input type="text" name="txtlogin" size="8" value="${requestScop.usuario.login }"/>	
			</div>
			<div class="margin">
				<label>Senha :</label>
				<input type="password" name="txtsenha" maxlength="8" value="${requestScop.usuario.senha }"/>
			</div>
			<div class="margin">
